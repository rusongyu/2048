...
export class GameManager {
	...
	constructor(size, InputManager: KeyboardInputManager, Actuator: HTMLActuator, StorageManager: LocalStorageManager) {
		...
		this.inputManager.on("keepPlaying", this.keepPlaying2.bind(this))
